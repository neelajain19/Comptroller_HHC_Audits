...
Based on the results produced by the key word text analysis, I thought the best way to filter the results and identify the key PDFs that I need to sort through was by creating a pivot table that would show the PDFs with the most frequent references to key words.  

After creating the pivot table, I noticed that the highest number (175) of mentions to non-unique keywords (total of 708) pertained to “William” in the context of my keyword search for “William Brown”, who was a former Chief Executive Officer of Coney Island Hospital. When I checked the “Search Term with 15 Words Context”  for these mentions in the results, the majority (if not all) were in the context of the mention of “William C. Thompson, Jr. Comptroller” on the first page of all the audit reports.  The low similar score (33.3) for all these identifications was reflective of that.  Therefore, I deduced that the keyword identification of this term did not yield information of value.  

Next I looked at the results for keyword searches for “Coney Island Hospital” and “Brooklyn Health South” as those are more specific terms than other keywords such as  “Medicaid Reimbursement” and “Fee for Service.”  Again, I focused on PDFs with most mentions of the hospital names.  

* For “Coney Island Hospital” the two PDFs with the most references were [MG03_142A](https://github.com/neelajain19/Comptroller_HHC_Audits/blob/d08b8d284bf0619078579cb693d2803f6df48d6d/Comptroller_Reports/MG03_142A.pdf) with 60 mentions and [MG07_111A](https://github.com/neelajain19/Comptroller_HHC_Audits/blob/2c7dd4357be8efdd0d7d0a49163ad12e61f9e0fa/Comptroller_Reports/MG07_111A.pdf) with 50 mentions.  After briefly skimming these PDFs I  realized that while these PDFs focused on audits specific to Coney Island Hospital which is helpful, the audit topic was not particularly relevant to my investigative story.  (The PDFs were focused, respectively, on Coney Island Hospital’s compliance with HHC timekeeping and payroll standards as well as whether the hospital had appropriate controls in place for inventory of its non-controlled drugs.)
* For the keyword “Brooklyn Health South,” the two PDFs with the most mentions were [ME10_094A](https://github.com/neelajain19/Comptroller_HHC_Audits/blob/0a48420b03dfbba19f95d888c196afe2d66300b1/Comptroller_Reports/ME10_094A.pdf) with 7 mentions  and MG03_142A with 6 mentions.  I already knew that PDF MG03_142A did not have relevant information to my story based on my prior review of it so I dismissed it.  When I checked the context of the keyword identification for PDF ME10_094A in the “Search Term” column I quickly realized that most of the references were in the context of lists of hospitals and naming the borough they were located in. Also considering that there were so few mentions of the hospital name, I also decided the PDF was not worth diving deeper into.

I then looked at some of the PDFs that had the most mentions of more general keywords such as “Medicaid reimbursement,” “Managed Care Organization” and “improper billing practices”.  I also wanted to focus on PDFs that had a significant number of mentions, not just in the single digits. This led me to hone in the following PDFs:

* [FM08_080A](https://github.com/neelajain19/Comptroller_HHC_Audits/blob/0a48420b03dfbba19f95d888c196afe2d66300b1/Comptroller_Reports/FM08_080A.pdf) which had 78 mentions of “Medicaid”, 18 mentions of “improper” and 24 mentions of “fees”
* [MD02_152F](https://github.com/neelajain19/Comptroller_HHC_Audits/blob/0a48420b03dfbba19f95d888c196afe2d66300b1/Comptroller_Reports/MD02_152F.pdf) which had 52 mentions of “Medicaid” and 48 mentions of “Managed”
* [ME10_067A](https://github.com/neelajain19/Comptroller_HHC_Audits/blob/0a48420b03dfbba19f95d888c196afe2d66300b1/Comptroller_Reports/ME10_067A.pdf) which had 86 mentions of “fee”

Considering the number of keyword references in PDF FM08_080A, I was hopeful this PDF would have information relevant to my investigative story. However, this PDF was an audit of how well HHS adhered to provisions in a Memo of Understanding (MOU) detailing the conditions under which HHC would send payments to the CIty for Emergency Medical Services transports. The audit found that HHC did not comply with the conditions of the MOU, improperly overbilled the City and also was delayed in sending payments to the City.  Although the content of this audit is not directly related to my investigative story, it does supply evidence that HHC's  general billing practices and financial controls have been lax and that the Office of the Comptroller requested improvements.

Next I looked at PDF MD02_152F which has several mentions of “Medicaid” and “Managed” in the context of ‘Managed Care.’ This PDF was particularly useful as it was a follow-up audit to determine if HHC had made improvements to its payment and collection practices as they relate to Medicaid Managed Care (MMC) and Health Maintenance Organizations (HMOs). One of the prior audit findings was that HHC only received payments from 72 billable accounts (only 14.5%) due to weaknesses in their billing and collections system.  One of the major factors contributing to this was a lack of training by HHC staff on billing practices as well as an inability to access basic billing and collection information. The audit found that HHC worked to potentially correct this issue by updating its contracting process with providers.

Last, I looked at PDF ME10_067A, which, although it had 85 mentions of “fees”, did not contain any applicable information as it was an audit report on Harlem Hospital’s affiliation contract with Columbia University.  (On second thought, “fee” is an extremely general term to look for even in the context of the larger term “fee for service” so I likely should have not included it as part of my keyword search.)
